...
CREATE TABLE IF NOT EXISTS TRIP (
    ...
    CONSTRAINT FK_TRIP_CRUISE FOREIGN KEY (CRUISE_ID) REFERENCES CRUISE(ID),
    CONSTRAINT FK_TRIP_DESTINATION FOREIGN KEY (DESTINATION_ID) REFERENCES DESTINATION(ID)
);
...
CREATE TABLE IF NOT EXISTS RATING (
    ...
    COMMENT VARCHAR(255),
    CRUISE_ID INTEGER NOT NULL,
    CONSTRAINT FK_RATING_CRUISE FOREIGN KEY (CRUISE_ID) REFERENCES CRUISE(ID)
);